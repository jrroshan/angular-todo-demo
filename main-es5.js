...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_todo_todo_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_todos_item_todos_item_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/todos-item/todos-item.component */
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _components_todo_todo_component__WEBPACK_IMPORTED_MODULE_6__["TodoComponent"], _components_todos_item_todos_item_component__WEBPACK_IMPORTED_MODULE_7__["TodosItemComponent"], _components_layout_header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"], _components_add_todo_add_todo_component__WEBPACK_IMPORTED_MODULE_9__["AddTodoComponent"], _components_pages_about_about_component__WEBPACK_IMPORTED_MODULE_10__["AboutComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppComponentsTodoTodoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _todos_item_todos_item_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../todos-item/todos-item.component */
    "./src/app/components/todos-item/todos-item.component.ts");

    function TodoComponent_app_todos_item_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-todos-item", 2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("deleteTodo", function TodoComponent_app_todos_item_1_Template_app_todos_item_deleteTodo_0_listener($event) {
    ...
    function () {
      ...
      _createClass(TodoComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.todoService.getTodo().subscribe(function (getDataFromServer) {
            _this.todos = getDataFromServer;
          });
        }
      }, {
        key: "deleteTodo",
        value: function deleteTodo(del) {
          //Remove From UI
        ...
        key: "addTodo",
        value: function addTodo(add) {
          var _this2 = this;

          this.todoService.addTodo(add).subscribe(function (add) {
            _this2.todos.push(add);
          });
        }
      }]);
    ...
    TodoComponent.ɵfac = function TodoComponent_Factory(t) {
      return new (t || TodoComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_todo_service__WEBPACK_IMPORTED_MODULE_1__["TodoService"]));
    };
    ...
    TodoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[3, "addTodo"], [3, "output", "deleteTodo", 4, "ngFor", "ngForOf"], [3, "output", "deleteTodo"]],
      template: function TodoComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("addTodo", function TodoComponent_Template_app_add_todo_addTodo_0_listener($event) {
      ...
      directives: [_add_todo_add_todo_component__WEBPACK_IMPORTED_MODULE_2__["AddTodoComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _todos_item_todos_item_component__WEBPACK_IMPORTED_MODULE_4__["TodosItemComponent"]],
  ...
  /***/
  function srcAppComponentsTodosItemTodosItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TodosItemComponent", function () {
    ...
    var TodosItemComponent =
    /*#__PURE__*/
    function () {
      function TodosItemComponent(todoService) {
        _classCallCheck(this, TodosItemComponent);

        this.todoService = todoService;
        this.deleteTodo = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
      }

      _createClass(TodosItemComponent, [{
        key: "ngOnInit",
        ...
        key: "onToggle",
        value: function onToggle(output) {
          //toggle in ui
          output.completed = !output.completed; //toggle in server

          this.todoService.toggleCompleted(output).subscribe(function (output) {
        ...
        key: "onDelete",
        value: function onDelete(output) {
    ...
    TodosItemComponent.ɵfac = function TodosItemComponent_Factory(t) {
      return new (t || TodosItemComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_todo_service__WEBPACK_IMPORTED_MODULE_1__["TodoService"]));
    };

    TodosItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: TodosItemComponent,
      selectors: [["app-todos-item"]],
      inputs: {
        output: "output"
      },
      outputs: {
      ...
      decls: 6,
      vars: 2,
      consts: [[3, "ngClass"], ["type", "checkbox", "name", "", "id", "", 3, "change"], [1, "del", 3, "click"]],
      template: function TodosItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function TodosItemComponent_Template_input_change_2_listener() {
            return ctx.onToggle(ctx.output);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodosItemComponent_Template_button_click_4_listener() {
            return ctx.onDelete(ctx.output);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TodosItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
    ...
    function () {
      ...
      _createClass(TodoService, [{
        ...
        value: function getTodo() {
          return this.http.get("".concat(this.todoUrl).concat(this.todoLimit));
        } //Delete Todo

      }, {
        key: "deleteTodo",
        value: function deleteTodo(del) {
          var url = "".concat(this.todoUrl, "/").concat(del.id);
        ...
        key: "toggleCompleted",
        value: function toggleCompleted(dataIn) {
          var url = "".concat(this.todoUrl, "/").concat(dataIn.id);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Roshan Lasiwa\Documents\program\todo\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
